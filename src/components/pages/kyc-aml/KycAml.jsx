          ...
          <div className={styles.div_title}>
            ...
            <div className={styles.div_description}>
              <p>
                ...
                AML-проверки поступающих от клиентов транзакций. Для этих целей
                Сервис использует всю доступную информацию, полученную законным
                путем, в том числе сторонние средства анализа без передачи
                данных клиента третьим лицам.
              </p>
              <p>
